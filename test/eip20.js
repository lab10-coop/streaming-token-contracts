...
exports.test = function(web3, accounts, ERC20CompatibleToken) {
    describe('ERC20', function() {
        ...
        beforeEach(async () => {
            HST = await ERC20CompatibleToken.new(10000, 'Some Bucks', 'SBX', 1, {from: accounts[0]});
        });
        ...
        it('creation: should succeed in creating over 2^255 - 1 tokens', async () => {
            const HST2 = await ERC20CompatibleToken.new(maxTokAmount, 'Some Bucks', 'SBX', 1, {from: accounts[0]});
